...
import { AddMessageAction, ResetAction, TxIsDone, TransitState } from "../../reducers/TransitMessageReducer";
...
export declare type InjectedAccountType = {
    address: string;
    meta: {
        name: string;
        source: string;
...
export interface HomeChainAdaptorContext {
    ...
    deposit(amount: number, recipient: string, tokenAddress: string, destinationChainId: number): Promise<void>;
    ...
    handleCheckSupplies?: (amount: number, tokenAddress: string, destinationChainId: number) => Promise<boolean | undefined>;
    tokens: Tokens;
