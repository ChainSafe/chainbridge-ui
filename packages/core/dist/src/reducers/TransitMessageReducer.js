...
exports.transitMessageReducer = void 0;
function transitMessageReducer(transitState, action) {
    switch (action.type) {
        case "addMessage":
            ...
            var uniqueMessagesSorted = uniqueMessages.sort(function (a, b) { return a.order - b.order; });
...
exports.transitMessageReducer = transitMessageReducer;
//# sourceMappingURL=TransitMessageReducer.js.map